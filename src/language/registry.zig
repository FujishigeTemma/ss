...
const primitive_descriptors = [_]PrimitiveDescriptor{
    ...
    .{ .op = .str_contains, .name = "str_contains", .min_arity = 2, .max_arity = 2, .arg_names = &.{ "text", "needle" }, .arg_types = &.{ Type.string, Type.string }, .result_type = Type.boolean, .summary = "Return whether a string contains another string" },
    .{ .op = .str_before, .name = "str_before", .min_arity = 2, .max_arity = 2, .arg_names = &.{ "text", "needle" }, .arg_types = &.{ Type.string, Type.string }, .result_type = Type.string, .summary = "Return the text before the first occurrence of a string" },
    .{ .op = .str_after, .name = "str_after", .min_arity = 2, .max_arity = 2, .arg_names = &.{ "text", "needle" }, .arg_types = &.{ Type.string, Type.string }, .result_type = Type.string, .summary = "Return the text after the first occurrence of a string" },
    ...
    .{ .op = .repr, .name = "repr", .min_arity = 1, .max_arity = 1, .arg_names = &.{"object"}, .arg_types = &.{Type.object}, .result_type = Type.string, .summary = "Return an object's display string" },
    ...
    .{ .op = .set_content, .name = "set_content", .min_arity = 2, .max_arity = 2, .arg_names = &.{ "object", "text" }, .arg_types = &.{ Type.object, Type.string }, .result_type = Type.object, .result_policy = .first_arg, .summary = "Define an object's textual content" },
    .{ .op = .set_repr, .name = "set_repr", .min_arity = 2, .max_arity = 2, .arg_names = &.{ "object", "function" }, .arg_types = &.{ Type.object, Type.function }, .result_type = Type.object, .result_policy = .first_arg, .summary = "Attach a display function to an object" },
    ...
    .{ .op = .place_overlay_on, .name = "place_overlay_on!", .min_arity = 2, .max_arity = 2, .arg_names = &.{ "page", "object" }, .arg_types = &.{ Type.page, Type.object }, .result_type = Type.object, .result_policy = .target_arg, .result_arg_index = 1, .places_objects = true, .summary = "Place an object outside the page flow" },
    ...
    .{ .op = .extend_render_env, .name = "extend_render_env", .min_arity = 4, .max_arity = 4, .arg_names = &.{ "target", "op", "key", "value" }, .arg_types = &.{ Type.any, Type.string, Type.string, Type.any }, .result_type = null, .result_policy = .target_arg, .summary = "Extend a scoped render environment" },
